...
| [`electron-app/`](electron-app/README.md) | Desktop surface over web-app: the Electron patch layer trading the HTTP carrier family for the IPC carrier | — (patch only) |
