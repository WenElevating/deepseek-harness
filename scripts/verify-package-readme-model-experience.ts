...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/connection-electron': { kind: 'none', reason: 'The IPC carrier bridges the renderer and the API handler and registers nothing model-facing.' },
  ...
  'packages/bundle/electron-app': { kind: 'indirect', reason: 'The bundle is a patch-list carrier over dsh-web-app that disables model-visible surfaces; each mounted row\'s package owns its model-facing behavior.' },
